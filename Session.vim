...
set shortmess=aoO
badd +2 main.cpp
badd +104 spreadsheetmainwindow.cpp
badd +1 spreadsheetmodel.cpp
badd +1 spreadsheetmainwindow.h
badd +11 spreadsheetmodel.h
badd +1 testspreadsheet.cpp
badd +1 testspreadsheet.h
badd +1 CMakeLists.txt
args main.cpp spreadsheetmainwindow.cpp spreadsheetmodel.cpp spreadsheetmainwindow.h spreadsheetmodel.h
edit spreadsheetmainwindow.h
...
36
normal! 029|
tabedit spreadsheetmainwindow.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
set winheight=1 winwidth=1
argglobal
edit spreadsheetmainwindow.cpp
let s:cpo_save=&cpo
set cpo&vim
imap <buffer> <silent> <S-F9> :call C_Arguments()
imap <buffer> <silent> <C-F9> :call C_Run()
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 121 - ((42 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
121
normal! 032|
tabedit testspreadsheet.cpp
set splitbelow splitright
set nosplitbelow
set nosplitright
wincmd t
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 10 - ((3 * winheight(0) + 24) / 49)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
10
